...
alias update='sudo apt update && sudo apt -y full-upgrade && sudo apt -y autoremove && cs update && refresh-completions && nix-channel --update && nix-env -u && cd ~/.dotfiles && gfa && nvim --headless +PackerSync +PlugUpdate +qall'
