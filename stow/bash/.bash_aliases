...
# alias update='sudo apt update && sudo apt -y upgrade && sudo apt -y dist-upgrade && sudo apt -y autoremove && exit'
alias update='sudo apt update && sudo apt -y full-upgrade && sudo apt -y autoremove && exit'
alias v='vim'
